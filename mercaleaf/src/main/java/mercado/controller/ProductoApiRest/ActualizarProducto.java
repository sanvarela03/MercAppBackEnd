...
@RestController
@RequestMapping("/mercapp/productores/actualizarProducto")
public class ActualizarProducto {
    ...
    @PostMapping("/actualizar/{idProductor}")
    public Producto actualizar(@RequestBody Producto producto,  @PathVariable("idProductor") Long idProductor) {
        if (producto == null) {
